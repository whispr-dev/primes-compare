...
int main() {
    try {
        ...
        benchmark.addProgram("c-primes-fast-gpetey", "D:/code/primes-compare/primes_ben/dist/c-primes-gpetey.exe", "");
        benchmark.addProgram("c-primes-fast-claude", "D:/code/primes-compare/primes_ben/dist/c-primes-claude.exe", "");
