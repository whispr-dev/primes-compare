...
int main() {
    try {
        ...
        benchmark.addProgram("c-primes-1e9", "D:/code/primes-compare/primes_ben/dist/c-primes-1e9.exe", "");
        benchmark.addProgram("c-primes-fast-1e9", "D:/code/primes-compare/primes_ben/dist/c-primes-fast-1e9.exe", "");
        benchmark.addProgram("r-primes-1e9", "D:/code/primes-compare/primes_ben/dist/r-primes-1e9.exe", "");
        benchmark.addProgram("r-primes-fast-1e9", "D:/code/primes-compare/primes_ben/dist/r-primes-fast-1e9.exe", "");
        benchmark.addProgram("c-primes-fast-gpetey-1e9", "D:/code/primes-compare/primes_ben/dist/c-primes-gpetey-1e9.exe", "");
        benchmark.addProgram("c-primes-fast-claude-1e9", "D:/code/primes-compare/primes_ben/dist/c-primes-claude-1e9.exe", "");
        benchmark.addProgram("c-primes-fast-gpetey-seg-1e9", "D:/code/primes-compare/primes_ben/dist/c-primes-gpetey-seg-1e9.exe", "");
        benchmark.addProgram("c-primes-fast-claude-seg-1e9", "D:/code/primes-compare/primes_ben/dist/c-primes-claude-seg-1e9.exe", "");
