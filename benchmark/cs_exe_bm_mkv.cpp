...
int main() {
    try {
        ...
        benchmark.addProgram("p-primes-smart-500", "D:/code/primes-compare/primes_ben/dist/p-primes-smart.exe", "500");
        benchmark.addProgram("p-primes-smart-50k", "D:/code/primes-compare/primes_ben/dist/p-primes-smart.exe", "50000");
        benchmark.addProgram("p-primes-smart-500k", "D:/code/primes-compare/primes_ben/dist/p-primes-smart.exe", "500000");

        // Original implementations (assuming they don't take arguments)
        benchmark.addProgram("c-primes", "D:/code/primes-compare/primes_ben/dist/c-primes.exe", "");
        benchmark.addProgram("c-primes-fast", "D:/code/primes-compare/primes_ben/dist/c-primes-fast.exe", "");
        benchmark.addProgram("r-primes", "D:/code/primes-compare/primes_ben/dist/r-primes.exe", "");
        benchmark.addProgram("r-primes-fast", "D:/code/primes-compare/primes_ben/dist/r-primes-fast.exe", "");
        benchmark.addProgram("r-primes-fast", "D:/code/primes-compare/primes_ben/dist/c-primes-gpetey.exe", "");
        benchmark.addProgram("r-primes-fast", "D:/code/primes-compare/primes_ben/dist/c-primes-claude.exe", "");
